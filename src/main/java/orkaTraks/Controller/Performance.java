...
public class Performance {
    ...
    @GetMapping("/api/performance/getWeeklyPerformance")
    public ResponseEntity<List<Task>>getWeeklyPerformance(@RequestParam String empId){
        try {
            Integer employeeId = Integer.parseInt(empId); // Convert string to integer
            List<Task> tasks = performanceservice.getWeeklyTasksByEmpId(employeeId);
    ...
    @GetMapping("/api/performance/getMonthlyPerformance")
    public ResponseEntity<Map<YearMonth, List<Task>>> getMonthlyPerformance(@RequestParam String empId) {
        try {
            Integer employeeId = Integer.parseInt(empId); // Convert string to integer
            Map<YearMonth, List<Task>> tasksByMonth = performanceservice.getAllMonthlyTasksByEmpId(employeeId);
